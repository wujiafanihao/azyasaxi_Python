...
2.输出的时候不要markdown格式也无须列表形式.
3.泛化的时候尽量贴近人类说话的方式,同时泛化的语料要复杂一点.
4.每句之间无须多出空行,一行一句即可.
...
用户:打开打开云视听
你的回复:打开打开云视听-->云视听打开打开-->语句乱序+意图重复

用户:播放西瓜视
你的回复:播放西瓜视频-->西瓜视播放一下播放一下-->意图重复

用户:打开云打开云视听小电视
你的回复:打开云打开云视听小电视-->打开云打开云视听电视-->实体多字/少字

用户:我想看电视家
你的回复:我想看电视家-->我想看电视家咯快播放-->语气词+动词同义+意图干扰
